...
class Matrix final
{
  private:
    ...
    Matrix<numberOfRows, numberOfCols> dealWithZeros(
        Matrix<numberOfRows, numberOfCols> matrix);
  ...
  public:
    ...
    Matrix<numberOfRows, numberOfCols> &operator+=(
        const Matrix<numberOfRows, numberOfCols> &other);
    Matrix<numberOfRows, numberOfCols> &operator-=(
        const Matrix<numberOfRows, numberOfCols> &other);
};
...
// ---------------Free functions---------------
template <size_t numberOfRows, size_t numberOfCols>
Matrix<numberOfCols, numberOfRows> transpose(
    const Matrix<numberOfRows, numberOfCols> &matrix);

template <size_t numberOfRows, size_t numberOfCols>
double det(Matrix<numberOfRows, numberOfCols> matrix);

template <size_t numberOfRows, size_t numberOfCols>
Matrix<numberOfRows, numberOfCols> inv(
    Matrix<numberOfRows, numberOfCols> matrix);
...
template <size_t numberOfRows, size_t numberOfCols>
Matrix<numberOfRows, numberOfCols> operator+(
    const Matrix<numberOfRows, numberOfCols> &l_other,
...
template <size_t numberOfRows, size_t numberOfCols>
Matrix<numberOfRows, numberOfRows> operator*(
    const Matrix<numberOfRows, numberOfCols> &l_other,
    const Matrix<numberOfCols, numberOfRows> &r_other);

template <size_t numberOfRows, size_t numberOfCols>
Matrix<numberOfRows, numberOfCols> operator+(
    Matrix<numberOfRows, numberOfCols> l_other, double r_other);
...
template <size_t numberOfRows, size_t numberOfCols>
Matrix<numberOfRows, numberOfCols> operator+(
    double l_other, Matrix<numberOfRows, numberOfCols> r_other);
...
{
    static_assert(numberOfRows == numberOfCols,
                  "diag() -> matrix must be square.");
...
template <size_t numberOfRows, size_t numberOfCols>
const double &Matrix<numberOfRows, numberOfCols>::operator()(unsigned i,
                                                             unsigned j) const
{
    return data[i][j];
}
